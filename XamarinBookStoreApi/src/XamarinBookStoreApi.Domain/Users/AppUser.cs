...
namespace XamarinBookStoreApi.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update XamarinBookStoreApiDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update XamarinBookStoreApiEfCoreEntityExtensionMappings to extend the IdentityUser entity
